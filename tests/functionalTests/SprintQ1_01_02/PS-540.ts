...
module.exports = {
    ...
    /**
     * Tickets Covered : PS-540	[Health - Web] Upload new AU Value hospital with co-payment products
                         PS-537	[Health - Data] Create Master Template for AU Value hospital with co-payment products
     *                   PS-538	[Health - Rapide/dB] Upload new products to Rapide and complete dB migration
     ...
     * 240550                 Value Hospital - $500 Excess (Silver Plus) AND Active Extras	QLD	       S	         B	    Tier2	   $298.25	       8.202	          24.462465	         35	       10	          $229.00	           22.9	   273.787535



     */
    'PS-540	[Health - Web] Upload new AU Value hospital with co-payment products': function (browser: NightwatchBrowser) {
