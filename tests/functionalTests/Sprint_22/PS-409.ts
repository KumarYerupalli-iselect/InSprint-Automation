...
module.exports = {
    ...
    /**
     * Tickets Covered : PS-409	[Energy - Web] Sunday messaging should be active on the funnel
     */
    'PS-409_EnergyWeb_Sunday_messaging_should_be_active_on_the_funnel': function (browser: NightwatchBrowser) {
        browser.url('https://wwwuat.iselect.com.au/');
        /** Clicks on Electricity abd Gas Icon in Home Page */
